...
- `runtime`: R 4.6.0, pyenv 2.7.2, Python 3.12.12, s6, and shared system
  libraries.
...
Published images use the versioned tag `4.6.0-py3.12.12-v1` as well as
`latest`. Application Dockerfiles should use the versioned tag.

Quarto, Pandoc, Hugo, and Node are build-only dependencies in `nd.site`; they
are intentionally excluded from the shared deployed runtime.
